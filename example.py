...
# Navbar button:
navbarBtn = tk.Button(topFrame, text='open', bg=color["orange"], activebackground=color["orange"], bd=0, padx=20, command=switch)
...
# Navbar Close Button:
closeBtn = tk.Button(navRoot, text='close', bg=color["orange"], activebackground=color["orange"], bd=0, command=switch)
